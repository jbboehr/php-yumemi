...
#define YYSTYPE         YUMEMI_PARSER_STYPE
#define YYLTYPE         YUMEMI_PARSER_LTYPE
/* Substitute the variable and function names.  */
#define yyparse         yumemi_parser_parse
#define yylex           yumemi_parser_lex
#define yyerror         yumemi_parser_error
#define yydebug         yumemi_parser_debug
#define yynerrs         yumemi_parser_nerrs
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_T_INTEGER = 3,                  /* "integer"  */
  YYSYMBOL_T_SUPERSCRIPT_INTEGER = 4,      /* "superscript integer"  */
  YYSYMBOL_T_INVALID_SUPERSCRIPT = 5,      /* "superscript sign without digits"  */
  YYSYMBOL_T_FLOAT = 6,                    /* "decimal number"  */
  YYSYMBOL_T_DOT = 7,                      /* "."  */
  YYSYMBOL_T_MUL = 8,                      /* "*"  */
  YYSYMBOL_T_DIV = 9,                      /* "/"  */
  YYSYMBOL_T_POW = 10,                     /* "^"  */
  YYSYMBOL_T_SUB = 11,                     /* "-"  */
  YYSYMBOL_T_ADD = 12,                     /* "+"  */
  YYSYMBOL_T_IDENTIFIER = 13,              /* "identifier"  */
  YYSYMBOL_T_LEFT_PAREN = 14,              /* "("  */
...
# endif
     ...
     && (! defined __cplusplus \
         || (defined YUMEMI_PARSER_LTYPE_IS_TRIVIAL && YUMEMI_PARSER_LTYPE_IS_TRIVIAL \
             && defined YUMEMI_PARSER_STYPE_IS_TRIVIAL && YUMEMI_PARSER_STYPE_IS_TRIVIAL)))
...
#define yyclearin       (yychar = YUMEMI_PARSER_EMPTY)
...
/* Backward compatibility with an undocumented macro.
   Use YUMEMI_PARSER_error or YUMEMI_PARSER_UNDEF. */
#define YYERRCODE YUMEMI_PARSER_UNDEF
...
#  elif defined YUMEMI_PARSER_LTYPE_IS_TRIVIAL && YUMEMI_PARSER_LTYPE_IS_TRIVIAL
...
yy_symbol_value_print (FILE *yyo,
                       yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, void *scanner, yumemi_parse_context *context)
{
  FILE *yyoutput = yyo;
  YY_USE (yyoutput);
  YY_USE (yylocationp);
...
yy_reduce_print (yy_state_t *yyssp, YYSTYPE *yyvsp, YYLTYPE *yylsp,
                 int yyrule, void *scanner, yumemi_parse_context *context)
{
...
int yydebug;
#else /* !YUMEMI_PARSER_DEBUG */
# define YYDPRINTF(Args) ((void) 0)
# define YY_SYMBOL_PRINT(Title, Kind, Value, Location)
# define YY_STACK_PRINT(Bottom, Top)
# define YY_REDUCE_PRINT(Rule)
#endif /* !YUMEMI_PARSER_DEBUG */
...
static int
yyreport_syntax_error (const yypcontext_t *yyctx, void *scanner, yumemi_parse_context *context);
...
yydestruct (const char *yymsg,
            yysymbol_kind_t yykind, YYSTYPE *yyvaluep, YYLTYPE *yylocationp, void *scanner, yumemi_parse_context *context)
{
  YY_USE (yyvaluep);
  YY_USE (yylocationp);
  YY_USE (scanner);
...
int
yyparse (void *scanner, yumemi_parse_context *context)
{
...
# if defined YUMEMI_PARSER_LTYPE_IS_TRIVIAL && YUMEMI_PARSER_LTYPE_IS_TRIVIAL
  = { 1, 1, 1, 1 }
# endif
;
...
#define YYPOPSTACK(N)   (yyvsp -= (N), yyssp -= (N), yylsp -= (N))
  ...
  yychar = YUMEMI_PARSER_EMPTY; /* Cause a token to be read.  */
...
yybackup:
  ...
  if (yychar <= YUMEMI_PARSER_EOF)
    {
      yychar = YUMEMI_PARSER_EOF;
      yytoken = YYSYMBOL_YYEOF;
      YYDPRINTF ((stderr, "Now at end of input.\n"));
    }
  else if (yychar == YUMEMI_PARSER_error)
    {
      /* The scanner already issued an error message, process directly
         to error recovery.  But do not keep the error token as
         lookahead, it is too special and may lead us to an endless
         loop in error recovery. */
      yychar = YUMEMI_PARSER_UNDEF;
...
yyreduce:
  ...
  case 5: /* additive_exp: additive_exp "+" product_exp  */
                                                { yyval.node = yumemi_ast_make_binary(context, YUMEMI_AST_ADD, yyvsp[-2].node, yyvsp[0].node, &(yyloc)); }
    break;

  case 6: /* additive_exp: additive_exp "-" product_exp  */
                                                { yyval.node = yumemi_ast_make_binary(context, YUMEMI_AST_SUB, yyvsp[-2].node, yyvsp[0].node, &(yyloc)); }
    break;
  ...
  case 8: /* product_exp: product_exp power_exp  */
                                                { yyval.node = yumemi_ast_make_binary(context, YUMEMI_AST_MUL, yyvsp[-1].node, yyvsp[0].node, &(yyloc)); }
    break;

  case 9: /* product_exp: product_exp "." unary_exp  */
                                                { yyval.node = yumemi_ast_make_binary(context, YUMEMI_AST_MUL, yyvsp[-2].node, yyvsp[0].node, &(yyloc)); }
    break;
  ...
  case 11: /* product_exp: product_exp "/" unary_exp  */
                                                { yyval.node = yumemi_ast_make_binary(context, YUMEMI_AST_DIV, yyvsp[-2].node, yyvsp[0].node, &(yyloc)); }
    break;
  ...
  case 13: /* unary_exp: "-" unary_exp  */
                                                { yyval.node = yumemi_ast_make_negation(context, yyvsp[0].node, &(yyloc)); }
    break;
  ...
  case 15: /* power_exp: simple "^" unary_exp  */
                                                { yyval.node = yumemi_ast_make_binary(context, YUMEMI_AST_POW, yyvsp[-2].node, yyvsp[0].node, &(yyloc)); }
    break;
  ...
  case 18: /* simple: identifier "@" signed_number  */
                                                { yyval.node = yumemi_ast_make_binary(context, YUMEMI_AST_AT, yyvsp[-2].node, yyvsp[0].node, &(yyloc)); }
    break;
  ...
  case 20: /* simple: simple "superscript integer"  */
                                                { yyval.node = yumemi_ast_make_binary(context, YUMEMI_AST_POW, yyvsp[-1].node, yumemi_ast_make_superscript_integer(context, yyvsp[0].text, yyvsp[0].length, &(yylsp[0])), &(yyloc)); }
    break;

  case 21: /* number: "integer"  */
                                                { yyval.node = yumemi_ast_make_leaf(context, YUMEMI_AST_INTEGER, yyvsp[0].text, yyvsp[0].length, &(yylsp[0])); }
    break;

  case 22: /* number: "decimal number"  */
                                                { yyval.node = yumemi_ast_make_leaf(context, YUMEMI_AST_FLOAT, yyvsp[0].text, yyvsp[0].length, &(yylsp[0])); }
    break;
  ...
  case 25: /* identifier: "identifier"  */
                                                { yyval.node = yumemi_ast_make_leaf(context, YUMEMI_AST_IDENTIFIER, yyvsp[0].text, yyvsp[0].length, &(yylsp[0])); }
    break;
...
yyerrlab:
  ...
  yytoken = yychar == YUMEMI_PARSER_EMPTY ? YYSYMBOL_YYEMPTY : YYTRANSLATE (yychar);
  ...
  if (!yyerrstatus)
    {
      ++yynerrs;
      {
        ...
        if (yyreport_syntax_error (&yyctx, scanner, context) == 2)
          YYNOMEM;
      }
    }
